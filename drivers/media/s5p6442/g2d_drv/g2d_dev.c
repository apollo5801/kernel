...
{
	u32 NumBytes;
	printk("g2d: s5p_g2d_GetNumBytesPerPixel : clrfmt : %d\n", ClrFmt);
	switch(ClrFmt){
		case G2D_RGBA_8888:
		case G2D_RGBX_8888:
		case G2D_ARGB_8888:
